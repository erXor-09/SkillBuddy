    ...
    return (
        <div className="w-full bg-[#101010] min-h-screen text-gray-200 font-sans pb-32">
            ...
            <div className="bg-[#151515] border-b border-[#2a2a2a] py-12 px-4 mb-20 text-center relative overflow-hidden">
                ...
                <p className="text-muted-clr text-lg max-w-2xl mx-auto">
            ...
            <div className="relative max-w-4xl mx-auto px-6 md:px-0">
                                ...
                                >
                                    <div className="bg-[#1a1a1a] rounded-[10px] p-6 h-full relative overflow-hidden">
                                        ...
                                        <div className="flex items-center justify-between mb-4">
                                            ...
                                            {module.status === 'locked' && <Lock className="w-3 h-3 text-secondary" />}
                                        </div>

                                        <h3 className="text-xl font-bold text-white mb-2">{module.title}</h3>
                                        <p className="text-sm text-muted-clr mb-6 line-clamp-2">{module.description}</p>
                                            ...
                                            {module.topics.map((topic, tIdx) => (
                                                ...
                                                >
                                                    <div className="flex items-center gap-4 flex-1">
                                                        ...
                                                        {/* Title */}
                                                        <span
                                                            className={`text-sm font-medium cursor-pointer flex-1 ${topic.status === 'completed' ? 'text-muted-clr line-through' : 'text-gray-200'}`}
                                                    ...
                                                    <ArrowDown
                                                        size={16}
                                                        className="text-secondary -rotate-90 opacity-0 group-hover/item:opacity-100 transition-opacity cursor-pointer"
                                                        onClick={() => onTopicClick && onTopicClick(module.id, topic.id)}
                                                    />
                                                </div>
                                            ))}
                ...
                <div className="absolute left-1/2 bottom-0 transform -translate-x-1/2 translate-y-full pt-8 flex flex-col items-center">
                    ...
                    <div className="px-6 py-2 border-2 border-[#262626] rounded-full text-secondary font-bold tracking-widest text-xs uppercase bg-[#101010]">
                        Goal Reached
                    </div>
                </div>
